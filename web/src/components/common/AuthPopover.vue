    ...
    <div class="auth-popover">
        <el-popover v-if="isLoggedIn" width="280" trigger="click">
            ...
            <template #default>
                ...
                <el-row class="uuid"
                    >uuid：{{ userStore.state.userInfo.uuid }}</el-row
                >
                <div class="container">
                    <el-row
                        >签名：{{ userStore.state.userInfo.signature }}</el-row
                    >
                    <div class="action-button">
                        <el-button @click="userStore.loginOut()"
                            >退出登录</el-button
                        >
                        <el-button @click="goIndexOrToDashboard">{{
                            label
                        }}</el-button>
                    </div>
                </div>
                    ...
                    <div class="auth-button">
                        <div class="button-item">
                            <el-button
                                class="login"
                                icon="User"
                                @click="layoutStore.state.loginVisible = true"
                            />
                            登录
                            <el-dialog
                        ...
                        <div class="button-item">
                            <el-button
                                ...
                                icon="Edit"
                                @click="
                                    layoutStore.state.registerVisible = true
                                "
                            />
                            注册
                            <el-dialog
                        ...
                        <div class="button-item">
                            <el-button
                                ...
                                icon="Unlock"
                                @click="
                                    layoutStore.state.forgotPasswordVisible = true
                                "
                            />
                            找回密码
                            <el-dialog
                                ...
                                align-center
                                :before-close="
                                    forgotPasswordVisibleSynchronization
                                "
                            >
