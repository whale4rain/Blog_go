        ...
        <div class="container">
            <div class="footer-left">
                <div class="full-logo">
                    <el-image
                        :src="
                            websiteStore.state.websiteInfo.full_logo === ''
                                ? '/image/full_logo.png'
                                : websiteStore.state.websiteInfo.full_logo
                        "
                        alt=""
...
const publicSecurityFilingLink = computed(
    () =>
        ...
        websiteStore.state.websiteInfo.public_security_filing.match(/\d+/),
);
