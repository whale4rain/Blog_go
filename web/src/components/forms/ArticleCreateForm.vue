    ...
    <div class="article-create-form">
        ...
        >
            <el-form-item label="文章封面" prop="cover">
                ...
                >
                    <el-image
                        v-if="articleCreateFormData.cover"
                        :src="articleCreateFormData.cover"
                        alt=""
                    />
                    ...
                    <template #tip>
                        <div class="el-upload__tip">
                            jpg/png/jpeg/ico/tiff/gif/svg/webp files with a size
                            less than 20MB.
                        </div>
                    </template>
                </el-upload>
            ...
            <el-form-item label="文章标签" prop="tags">
                <el-tag
                    v-for="tag in articleCreateFormData.tags"
                    :key="tag"
                    closable
...
const articleCreateFormData = reactive<ArticleCreateRequest>({
    cover: "",
    title: props.title,
    category: props.aiMeta?.category ?? "",
    tags: props.aiMeta?.tags ?? [],
    abstract: props.aiMeta?.summary ?? "",
...
const handleClose = (tag: string) => {
    articleCreateFormData.tags.splice(
        articleCreateFormData.tags.indexOf(tag),
        1,
    );
};
