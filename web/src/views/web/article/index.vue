            ...
            <div class="container">
                <el-main>
                    <div class="info">
                        ...
                        <div class="time">
                            <el-text
                                >发布：{{ articleInfo.created_at }} 更新：{{
                                    articleInfo.updated_at
                                }}</el-text
                            >
                        </div>
                        <el-row class="category"
                            >类别：{{ articleInfo.category }}</el-row
                        >
                        <el-row class="tags"
                            >标签：
                            <el-tag
                    ...
                    <div class="comment" id="comment">
                        <el-input
                            ...
                            type="textarea"
                            placeholder="喜欢这篇文章吗？在这里与大家分享您的想法！"
                            maxlength="320"
                        />
                        ...
                        <div class="operation">
                            ...
                            <div class="button-group">
                                <el-button
                                    ...
                                    >发表</el-button
                                >
                                <el-button size="large" @click="content = ''"
                                    >取消</el-button
                                >
                            </div>
                        </div>
...
const numbers = ref(
    Array.from({ length: 50 }, (_, i) => (i + 1).toString().padStart(2, "0")),
);
