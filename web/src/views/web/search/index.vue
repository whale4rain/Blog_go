            ...
            <div class="container">
                <el-main>
                    <div class="search">
                        ...
                        />
                        <el-button @click="changeArticleSearchItem"
                            >搜索</el-button
                        >
                    </div>
                    ...
                    <div class="category">
                        ...
                        <el-radio-group
                            v-model="articleSearchRequest.category"
                            @change="changeArticleSearchItem"
                        >
                    ...
                    <div class="tag">
                        ...
                        <el-radio-group
                            v-model="articleSearchRequest.tag"
                            @change="changeArticleSearchItem"
                        >
                            <el-radio-button label="全部" value="" />
                    ...
                    <div class="sort">
                        ...
                        <el-radio-group
                            v-model="articleSearchRequest.sort"
                            ...
                            <el-table-column label="description">
                                ...
                                >
                                    <div
                                        class="description"
                                        @click="
                                            handleArticleJumps(scope.row._id)
                                        "
                                    >
                                        <el-row class="title">{{
...
const handleSortClick = () => {
    articleSearchRequest.order =
        articleSearchRequest.order === "desc" ? "asc" : "desc";
};
